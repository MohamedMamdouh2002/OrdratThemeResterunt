            ...
            {selectedFaqCategory?.faQs?.map((faq, index) => (
              <div key={`${index}`} className="mb-8 relative rounded-xl shadow-lg border border-mainColor border-s-0">
                <button
                  ...
                  className={`relative 4xl:h-auto bg-white dark:bg-secDark dark:text-white font-monbold flex justify-between items-center w-full ps-0 p-4 border h-auto md:h-min-[90px]
