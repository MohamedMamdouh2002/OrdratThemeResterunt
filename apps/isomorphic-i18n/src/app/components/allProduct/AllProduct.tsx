...
export default function AllProduct({
  ...
  const fetchedPages = useRef<Set<number>>(new Set([initialPage])); // سجل الصفحة الأولى
      ...
      const fetchProducts = async () => {
          ...
          try {
              const response = await fetch(
                  `${API_BASE_URL}/api/Category/GetProductsByCategoryDetailed/952E762C-010D-4E2B-8035-26668D99E23E?categoryId=${categoryId}&PageNumber=${page}&PageSize=4`,
                  {
            headers: {
